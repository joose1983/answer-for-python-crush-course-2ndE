...
class TargetPractice:
    ...
    def _update_bullets(self):
        ...
        if self.stats.missed_bullets >= self.stats.rectangle_miss_max:
            self.stats.game_active = False
            pygame.mouse.set_visible(True)
              

    def _update_rectangle(self):
        if self.stats.fired_bullets >=5:
            self.stats.increase_speed()
            self.stats.fired_bullets = 0
...
class Rectangle(Sprite):
    ...
    def __init__(self, tp_game):
        ...
        self.rect =self.image.get_rect()
        self.rectangle_speed = tp_game.stats.rectangle_speed
    ...
    def update(self):
        ...
        if self.moving_up:
            self.y -= self.stats.rectangle_speed

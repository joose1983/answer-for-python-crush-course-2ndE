...
class AlienInvasion:
    ...
    def _update_missiles(self):
        self._check_missile_edges()
        self.missiles.update()
        self._check_bullet_missile_collisions()


          
    def _check_missile_edges(self):
        """Respond appropriately if any missile have reached an edge."""
        for missile in self.missiles.sprites():
            if missile.check_edges():
                self.settings.missile_direction *= -1
                break

    def _check_bullet_missile_collisions(self):
        
        """Respond to bullet-missile collisions."""
        # Remove any bullets and aliens that have collided.
        collisions = pygame.sprite.groupcollide(
            self.bullets, self.missiles, True, True)
